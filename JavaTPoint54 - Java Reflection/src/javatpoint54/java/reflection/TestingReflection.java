...
public class TestingReflection {
    ...
    public static void main(String[] args) {
        ...
        //Get interfaces that the class implements.
        for (Class superInterface : interfaces) {
            System.out.println("------------------------------------");
            System.out.println("Super Interface "+i+": " +(superInterface.getName()));
            i++;
        ...
        for (Method method : classMethods) {
            ...
            //Get all method parameters, notic that the parameter have a type Class;
