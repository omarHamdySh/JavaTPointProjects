...
public class StoreData {
    ...
    public void save() {
        ...
        //Creating a builder reference variable, to send it as a parameter to build the session factory.
        //Thats because the buildSessionFactory() method that takes no parameters is deprecated.
